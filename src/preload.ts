...
const api: GameShelfApi = {
  ...
  renameCollection: (collectionId, name) => ipcRenderer.invoke('collections:rename', collectionId, name),
  ...
  setCollectionOrder: (collectionId, gameIds) => ipcRenderer.invoke('collections:set-order', collectionId, gameIds),
  listPackages: (gameId) => ipcRenderer.invoke('packages:list', gameId),
  detectPackages: (gameId) => ipcRenderer.invoke('packages:detect', gameId),
  listPackageChanges: (gameId) => ipcRenderer.invoke('packages:changes', gameId),
  previewPackageChange: (gameId, packageId, enabled) => ipcRenderer.invoke('packages:preview-change', gameId, packageId, enabled),
  applyPackageChange: (token) => ipcRenderer.invoke('packages:apply-change', token),
  pickSaveDirectory: () => ipcRenderer.invoke('saves:pick-directory'),
  listSaveLocations: (gameId) => ipcRenderer.invoke('saves:list', gameId),
  addSaveLocation: (gameId, name, savePath) => ipcRenderer.invoke('saves:add-location', gameId, name, savePath),
  createSaveBranch: (locationId, name) => ipcRenderer.invoke('saves:create-branch', locationId, name),
  createSaveSnapshot: (branchId, name) => ipcRenderer.invoke('saves:create-snapshot', branchId, name),
  previewSaveRestore: (snapshotId) => ipcRenderer.invoke('saves:preview-restore', snapshotId),
  applySaveRestore: (token) => ipcRenderer.invoke('saves:apply-restore', token),
