...
const api: GameShelfApi = {
  ...
  scanLibrary: () => ipcRenderer.invoke('games:scan-library'),
  importGames: (inputs) => ipcRenderer.invoke('games:import', inputs),
  bulkEditGames: (input) => ipcRenderer.invoke('games:bulk-edit', input),
